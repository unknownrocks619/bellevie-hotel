...
<div class="card">
    <div class="card-header">Edit: {{ $roomType->name }}</div>
    <div class="card-body">
        <form action="{{ route('admin.room-types.update', $roomType) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <span class="input-group-text"><i id="iconPreview" class="bi {{ $roomType->icon ?? 'bi-door-closed' }}"></i></span>
                ...
                <div class="col-md-4 d-flex align-items-end">
                    <div class="form-check mb-2">
                        <input type="checkbox" name="is_active" class="form-check-input" id="is_active"
                               value="1" {{ $roomType->is_active ? 'checked' : '' }}>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn" style="background:#C9A227;color:white;border:none;">Update Room Type</button>
