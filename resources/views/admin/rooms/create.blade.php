                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" step="0.01" name="weekend_price"
                                                    class="form-control" value="{{ old('weekend_price') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="view_type" class="form-control"
                                                value="{{ old('view_type') }}" placeholder="Ocean, Garden…">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-0">
                                            ...
                                            <input type="number" name="max_children"
                                                ...
                                                value="{{ old('max_children', 0) }}" min="0">
                                            @error('max_children')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="rounded p-3 mb-4" style="background:#fdf8ea;border:1px solid #f0e0b0;">
                            ...
                            <p class="mb-0" style="font-size:.74rem;color:#8a6d00;line-height:1.4;">
                                When off, the price is hidden on listings &amp; the detail page. Guests see
                                <em>"Price on request"</em> instead.
                            </p>
                        </div>

                        <button type="submit" class="btn w-100 text-white"
                            style="background:#C9A227;border:none;">Create Room</button>
