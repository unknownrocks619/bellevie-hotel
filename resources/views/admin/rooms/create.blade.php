    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <ul class="nav nav-tabs mb-0" style="border-bottom:none;">
                <li class="nav-item">
                    <button class="nav-link active" type="button" data-bs-toggle="tab" data-bs-target="#tabDetails">
                        <i class="bi bi-door-open me-1"></i>Room Details
                    </button>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content" style="border:1px solid #dee2e6; border-top:none; border-radius:0 0 8px 8px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" step="0.01" name="weekend_price" class="form-control" value="{{ old('weekend_price') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="view_type" class="form-control" value="{{ old('view_type') }}" placeholder="Ocean, Garden…">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-0">
                                        ...
                                        <input type="number" name="max_adults" class="form-control @error('max_adults') is-invalid @enderror" value="{{ old('max_adults', 2) }}" min="1">
                ...
                <div class="tab-pane fade p-4" id="tabSeo">
        ...
        <div class="col-lg-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <button type="submit" class="btn w-100 text-white" style="background:#C9A227;border:none;">Create Room</button>
