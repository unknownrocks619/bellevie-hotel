        ...
        <div class="col-lg-8 offset-lg-2">
            ...
            <div class="card mb-4 shadow-sm" style="border-left: 5px solid #C9A227;">
                <div class="card-header" style="background:#F5F0E8; border-bottom: none;">
                    <h6 class="mb-0" style="color: #0D1B2A; font-weight: 600;">Your Booking Reference</h6>
                </div>
                <div class="card-body text-center py-4">
                    <div style="font-size: 2.5rem; font-weight: bold; color:#C9A227; letter-spacing: 2px; font-family: 'Courier New', monospace;">
            ...
            <div class="card mb-4 shadow-sm" style="background:#F5F0E8; border: none; border-left: 5px solid #C9A227;">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            <p class="text-muted mb-0">{{ $booking->nights ?? 1 }} Night{{ isset($booking->nights) && $booking->nights > 1 ? 's' : '' }}</p>
                        </div>
                        <div class="col-6 text-end">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <p class="mb-0" style="color:#C9A227; font-size: 1.5rem; font-weight: 700;">${{ number_format($booking->total_amount ?? 0, 2) }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="alert alert-info mb-4" style="border-left: 4px solid #0dcaf0;">
                <div class="d-flex align-items-start gap-2">
                    ...
                    <div>
                        ...
                        <p class="mb-0">A confirmation email has been sent to <strong>{{ $booking->guest_email }}</strong>. Please check your inbox (and spam folder) for booking details.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex gap-2 justify-content-center mb-3">
                ...
                <a href="{{ route('home') }}" class="btn" style="background:#C9A227; color:white; border:none;">Return to Home</a>
            </div>
            ...
            <div class="text-center pt-3" style="border-top: 1px solid #ddd;">
                ...
                <a href="{{ route('booking.cancel', ['booking' => $booking->id, 'token' => $booking->cancellation_token ?? '']) }}" class="text-danger text-decoration-none" style="font-size: 0.9rem;">
