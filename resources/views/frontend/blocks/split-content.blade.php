@php
    ...
    $cldUrl = function (string $pid, int $w, int $h) use ($cloudName): string {
        ...
        return "https://res.cloudinary.com/{$cloudName}/image/upload/c_fill,w_auto,h_{$h},g_auto,q_auto,f_auto/{$pid}";
    };
    ...
    <div class="container">
        <div class="row align-items-center g-5 {{ $imageLeft ? 'flex-row-reverse' : '' }}">
            ...
            <div class="col-lg-6">
                ...
                @if ($eyebrow)
                    <p
                        style="color:#C9A227;font-weight:700;font-size:0.78rem;
                ...
                @if ($subheading)
                    <h3
                        style="font-size:1.25rem;font-weight:700;color:#0D1B2A;
                ...
                @if ($hasContact)
                    <div style="display:flex;align-items:center;gap:16px;margin-top:8px;">
                        <div
                            ...
                            <i class="bi {{ $contactIcon }}" style="font-size:1.25rem;color:#C9A227;"></i>
                        </div>
                        <div>
                            @if ($contactLabel)
                                <p
                                    style="font-size:0.78rem;color:#888;margin:0 0 2px;
                ...
                <div class="col-lg-6">
                    @if ($hasTwoImgs)
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;align-items:stretch;">
                            ...
                            <div
                                style="border-radius:8px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,.12);
                                margin-top:40px;">
                    ...
                    @else
                        ...
                        <div style="border-radius:8px;overflow:hidden;box-shadow:0 6px 30px rgba(0,0,0,.14);">
                            <img src="{{ $src1 }}" alt="{{ $title }}" class="img-fluid d-block w-100"
